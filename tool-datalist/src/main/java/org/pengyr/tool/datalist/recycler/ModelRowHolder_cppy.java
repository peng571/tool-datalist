...
// */
//public abstract class ModelRowHolder_cppy<T> extends RecyclerView.ViewHolder {
//
...
//
//    public ModelRowHolder_cppy(final View itemView) {
//        super(itemView);
...
//        clickListener.onItemClick(ModelRowHolder_cppy.this, index, object);
//    };
//
//    final protected View.OnLongClickListener longListener = (View view) -> {
//        if (longClickListener == null) return true;
//        longClickListener.onItemLongClick(ModelRowHolder_cppy.this, index, object);
//        return false;
//    };
//
//
...
//     * @return this
//     */
//    public ModelRowHolder_cppy<T> listen(OnItemClickListener<T> listener) {
//        this.clickListener = listener;
//        return this;
//    }
//
//    public ModelRowHolder_cppy<T> listen(OnItemLongClickListener<T> listener) {
